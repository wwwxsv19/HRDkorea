...
<section>
	...
	%>
	<form name="frm1" action="maction.jsp" method="get">
	<table border=1>
		<tr>
			<td>선수번호</td>
			<td style="text-align:left;"><input type="text" name="pid" value="<%= pid %>" readonly></td>
		</tr>
		<tr>
			<td>선수이름</td>
			<td style="text-align:left;"><input type="text" name="pname" value="<%= pname %>"></td>
		</tr>
		<tr>
			<td>선수포지션</td>
		...
		<tr>
			<td>선수등록일</td>
			<td style="text-align:left;"><input type="text" name="pdate" value="<%= pdate %>"></td>
		</tr>
		<tr>
			<td>선수등급</td>
			<td style="text-align:left;">
		...
		<tr>
			<td colspan=2>
				<input type="submit" value="수정" onclick="mcheck()">
				<input type="button" value="취소" onclick="mres()">
			</td>
		</tr>
	</table>
	</form>
